    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valuer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='propertyAssessment', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='property',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userRecipient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='receivedMessagesU', to=settings.AUTH_USER_MODEL)),
                ('userSender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sentMessagesU', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
