    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Salud', 'Health'), ('Alimentación', 'Feeding'), ('Deporte', 'Sport'), ('Entretenimiento', 'Entertainment'), ('Transporte', 'Transport'), ('Educación', 'Education')], default='-', max_length=17)),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dormitories', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valued', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluationsReceived', to='api.user')),
                ('valuer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userRatings', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.CharField(max_length=1000)),
                ('date', models.DateField(auto_now_add=True)),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='propertyRatings', to='api.property')),
                ('valuer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='propertyAssessment', to='api.user')),
            ],
        ),
        migrations.AddField(
            model_name='property',
            name='rules',
            field=models.ManyToManyField(blank=True, to='api.rule'),
        ),
        migrations.AddField(
            model_name='property',
            name='services',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adminRecipient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='receivedMessagesA', to='api.admin')),
                ('adminSender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sentMessagesA', to='api.admin')),
                ('userRecipient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='receivedMessagesU', to='api.user')),
                ('userSender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sentMessagesU', to='api.user')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interestService', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.interestservice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to='studentsAnnouncement/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='groupReservationAssigned', to='api.admin')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groupReservationStudent', to='api.student')),
            ],
        ),
        migrations.CreateModel(
            name='Experience',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='studentExperiences', to='api.student')),
            ],
        ),
    ]
