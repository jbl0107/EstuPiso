...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='property',
            name='rules',
            field=models.ManyToManyField(blank=True, related_name='rules', to='apis.rule'),
        ),
        migrations.AddField(
            model_name='property',
            name='services',
        ...
        migrations.AddField(
            model_name='property',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='properties', to='apis.owner'),
        ),
        migrations.CreateModel(
