...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='property',
            name='rules',
            field=models.ManyToManyField(blank=True, to='apis.rule'),
        ),
        migrations.AddField(
            model_name='property',
            name='services',
            field=models.ManyToManyField(blank=True, to='apis.service'),
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
        ...
        migrations.AddField(
            model_name='property',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.owner'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='groupReservationAssigned', to=settings.AUTH_USER_MODEL)),
