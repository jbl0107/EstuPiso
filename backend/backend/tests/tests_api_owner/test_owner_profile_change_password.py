...
class TestOwnerProfileChangePassword(APITestCase):
    ...
    def test_negative(self):
        response = self.client.put(f'/owners/profile-pass-change')
    ...
    def test_positive(self):
        ...
        response = self.client.put(f'/owners/profile-pass-change', password)
